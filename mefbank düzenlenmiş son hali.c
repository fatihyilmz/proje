...
void dosyaya_aktar(int index){ //Bu fonksiyonumuz para yatirilip cekildiðinde veya gonderildiðinde degisen verileri oncekileri silerek tekrar dosyaya yazdirir.                               
...
void kayit_sil(){ // Silinebilecek hesaplari dosyadan tarar. Eger varsa bilgileri ister. Bilgiler dosyadakiler ile uyusursa kullanicinin butun bilgilerini sýfýrlar.
    int index = 0;
    hesapSorgu=1;
